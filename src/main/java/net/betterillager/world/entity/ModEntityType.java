...
public class ModEntityType {
    ...
    public static final Supplier<EntityType<@NotNull FrozenVindicator>> FROZEN_VINDICATOR =
            ENTITY_TYPES.registerEntityType("frozen_vindicator", FrozenVindicator::new, MobCategory.MONSTER);
